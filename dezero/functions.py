...
from dezero.utils import sum_to as utils_sum_to
from dezero.utils import logsumexp as utils_logsumexp
...
class SoftmaxCrossEntropy(Function):
    def forward(self, x, t):
        N = x.shape[0]
        log_z = utils_logsumexp(x, axis=1)
        log_p = x - log_z
